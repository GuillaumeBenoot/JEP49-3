...
git clone https://github.com/burnpiro/reveal-drawer.git --depth 1  temp
mkdir reveal.js/plugin/drawer
cp temp/dist/drawer.js reveal.js/plugin/drawer/
cp temp/dist/drawer.css reveal.js/plugin/drawer/
rm -rf temp
