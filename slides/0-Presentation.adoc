...
Le JDK c'est le *java developpement kit*, et il contient tout un tas d'outils et de librairie qui vont aider le développeur Java à créer des applications.

Avec chaque mise à jour du JDK, on entend parler des JEP qui y sont ajoutées, mais c'est quoi une JEP ?
--